...
let articlesDatabase = [
  { "title" : "Güney Kore yapay zeka zirvesi: Dünya liderleri güvenlik enstitüleri ağı kurma konusunda anlaştı",
    "link" : "https://tr.euronews.com/2024/05/22/guney-kore-yapay-zeka-zirvesi-dunya-liderleri-guvenlik-enstituleri-agi-kurma-konusunda-anl",
    "date" : "2024",
  ...
  { "title" : "Algoritmalarda önyargıyla nasıl mücadele ediyorum",
    ...
    "desc" : 'MIT yüksek lisans öğrencisi Joy Buolamwini yüz analiz yazılımıyla çalışırken bir sorun fark etti: Yazılım onun yüzünü tespit edemedi; çünkü algoritmayı kodlayan kişiler ona çok çeşitli cilt tonlarını ve yüz yapılarını tanımlamayı öğretmemişti.'
  }
];
